...
export default function PayoneerDashboard({ go }) {
  ...
  const loadSources = async () => {
    ...
    try {
      ...
      const mappedReal = realSources.map((s) => ({
        id: s.source,
        type: s.source,
        name: s.source === "payoneer" ? "Payoneer Payouts" : s.source,
  ...
  const incomeLabel = hasRealPayoneer ? "Reconnect Payoneer" : "Connect Payoneer";
