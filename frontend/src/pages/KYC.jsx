    ...
    <div className="min-h-screen bg-white">
      <div className="w-full overflow-hidden bg-white md:grid md:min-h-screen md:grid-cols-2">
        ...
        <section className="flex min-h-[52vh] flex-col justify-between p-8 md:min-h-screen md:p-12">
          ...
          {stage === "nic" ? <NicForm nic={nic} setNic={setNic} sendCode={sendCode} loading={loading} error={error} /> : <OtpForm email={email} otp={otp} setOtp={setOtp} verify={verify} loading={loading} error={error} resend={sendCode} />}
        </section>
      </div>
    </div>
  );
