...
export const DEMO_PROFILES = [
  {
    ...
    bills: [
      { biller: "Dialog Mobile Prepaid", account: "077••••2000", months: 5, ontime_rate: 0.2, avg_bill_lkr: 1490, holder: "self" },
      { biller: "CEB (landlord account)", account: "—", months: 0, ontime_rate: null, avg_bill_lkr: null, holder: "landlord", note: "Cannot attribute — excluded" },
      { biller: "SLT Fibre (shared)", account: "—", months: 0, ontime_rate: null, avg_bill_lkr: null, holder: "shared", note: "Cannot attribute — excluded" },
    ],
    payment_features: {
      bill_ontime_rate: 0.2,
  ...
  },
  {
    ...
    bills: [
      { biller: "CEB", account: "CEB-41••••2000", months: 8, ontime_rate: 0.875, avg_bill_lkr: 5200, holder: "self" },
      { biller: "SLT Fibre", account: "047••••2111", months: 6, ontime_rate: 0.833, avg_bill_lkr: 4500, holder: "self" },
      { biller: "Dialog Postpaid", account: "077••••2222", months: 4, ontime_rate: 0.75, avg_bill_lkr: 2200, holder: "self" },
      { biller: "NWSDB Water", account: "NWS-88••••3333", months: 2, ontime_rate: 0.5, avg_bill_lkr: 1800, holder: "self" },
    ],
    payment_features: {
      bill_ontime_rate: 0.8,
  ...
  },
  {
    ...
    bills: [
      { biller: "CEB", account: "CEB-41••••2000", months: 10, ontime_rate: 1.0, avg_bill_lkr: 5200, holder: "self" },
      { biller: "SLT Fibre + PEO TV", account: "047••••2111", months: 6, ontime_rate: 1.0, avg_bill_lkr: 4500, holder: "self" },
      { biller: "Dialog Postpaid ×2", account: "077••••2222", months: 4, ontime_rate: 1.0, avg_bill_lkr: 2200, holder: "self" },
      { biller: "NWSDB Water", account: "NWS-88••••3333", months: 2, ontime_rate: 1.0, avg_bill_lkr: 1800, holder: "self" },
      { biller: "Koko BNPL", account: "KOKO••••4444", months: 14, ontime_rate: 1.0, avg_bill_lkr: 18000, holder: "self", note: "Removes BNPL default penalty" },
    ],
    payment_features: {
      bill_ontime_rate: 1.0,
      bill_months_coverage: 22,
