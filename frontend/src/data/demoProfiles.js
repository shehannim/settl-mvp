...
export const DEMO_PROFILES = [
  {
    ...
    monthly_lkr_12m: [52000, 44000, 61000, 28000, 0, 0, 35000, 47000, 22000, 0, 41000, 38000],
    income_features: {
      income_cv: 0.72,
      income_trend_slope: -0.08,
      income_gap_months: 3,
    ...
    expected_score: {
      ...
      band: "weak",
      confidence: 0.31,
      verdict: "Needs support — score exists where CRIB has nothing, but confidence gates any approval.",
      top_positive_factors: ["Identity verified", "9-month platform history", "Prepaid discipline (Dialog 75%)"],
      top_negative_factors: ["3 income gap months", "Single income source", "Low bill coverage (landlord-held utilities)"],
      improvement_tips: [
    ...
    video_beats: [
      "Show the 3 zero months on the income chart — then the score that still exists.",
      "Contrast: CRIB screen = No-Hit vs Settl screen = 431 with reasons.",
  ...
  },
  {
    ...
    income_features: {
      income_cv: 0.11,
      income_trend_slope: 0.06,
      income_gap_months: 0,
      income_source_count: 2,
      income_3m_avg: 1.68,
      income_6m_avg: 1.64,
      income_yoy_growth: 0.22,
    },
    bills: [
